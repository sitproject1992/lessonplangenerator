        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-10">
          ...
          <div className="grid grid-cols-4 gap-6 pt-6 border-t border-gray-50">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-lg font-bold text-gray-800">{document.subject || 'N/A'}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Grade(s)</span>
              <span className="text-lg font-bold text-gray-800">{document.grades?.join(', ') || 'N/A'}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Chapters</span>
              <span className="text-lg font-bold text-gray-800">{Object.keys(chapters).length}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Total Topics</span>
              <span className="text-lg font-bold text-gray-800">{structure.length}</span>
            </div>
          </div>
        </div>
